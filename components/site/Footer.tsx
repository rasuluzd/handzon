...
export function Footer() {
  ...
  return (
    <footer className="mt-6 border-t border-line bg-surface-alt px-6 pb-10 pt-9">
      ...
      <p className="max-w-3xl text-[13.5px] leading-relaxed text-muted-light">
        © 2026 Handz On Auto Care · Franchisekjede med 15 lokale avdelinger. Hver
        avdeling drives av egen juridisk enhet. Alle avdelinger er registrert i
